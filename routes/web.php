...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/details',[App\Http\Controllers\prosesTiket::class, 'prosesData'])->name('proses');

    Route::post('/payment',[App\Http\Controllers\payment::class, 'store'])->name('bayar');
    Route::post('/finalisasi',[App\Http\Controllers\payment::class, 'finalisasi'])->name('finalBayar');
    Route::get('/done',[App\Http\Controllers\payment::class, 'success']);
