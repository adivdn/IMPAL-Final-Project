...
<head>
	...
	<title>DTRAIN.CJ | Landing Page</title>
		...
		<div class="container">
			<div class="dropdown">
	          ...
	          <div class="dropdown-menu dropdown-menu-left" style="">
	            <a class="dropdown-item text-navy" href="{{url('/')}}"><i class="fas fa-fw fa-home mr-3"></i>Home</a>
			...
			<a class="navbar-brand" href="{{url('/')}}"><img src="images/logo.png" alt="logo" height="40"></a>

			<form class="form-inline my-2 my-lg-0 ml-auto" method="POST" action="{{route('login')}}">
			{{ csrf_field() }}
				<div class="dropdown">
		          <a class="btn btn-light mr-3 dropdown-toggle widht-btn1" data-toggle="dropdown" href="#"><i class="far fa-fw fa-user mr-2"></i>Log In</a>
		          <div class="dropdown-menu dropdown-menu-right p-4" style="width: 300px;">
					    ...
					    <div class="form-group mb-2">
					      ...
					      <input type="email" name="email" class="form-control w-100" id="email" placeholder="Email">
					    </div>
					    <div class="form-group mb-3">
					      <label for="password">Password</label>
					      <small class="ml-auto"><a href="#">Forget Password?</a></small>
					      <input type="password" name="password" class="form-control w-100" id="password" placeholder="Password">
					    </div>
					    <div class="text-right">
						    <button type="submit" class="btn bg-amber btn-sm widht-btn2 mb-2">Login in</button>
					    </div>
			
					  <div class="dropdown-divider"></div>
					  <div class="text-center">
							<small>Or log in with</small> <br>
					  		<a href="{{route('registergoogle')}}" class="btn btn-sm btn-danger widht-btn2">Google</a>
					  		 |
					  		<a href="#" class="btn btn-sm btn-primary widht-btn2">Facebook</a>
					  </div>
					</div>
		        </div>

				<a href="{{url('/register')}}" class="btn bg-navy my-2 my-sm-0 widht-btn1">Register</a>
			</form>
		</div>
		</div>
	</nav>
